...
<h5>Front-End Development:</h5>
    ...
    <li>CSS: Styling layouts and designing responsive, mobile-first websites.</li>
    <li>JavaScript: Creating interactive features (e.g., form validation, dynamic content loading).</li>
    <li>React.js: Developing modern, single-page applications with reusable components.</li>
    ...
    <li>MySQL/PostgreSQL: Relational database management for structured data.</li>
